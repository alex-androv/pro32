...
const filteredPartners = computed(() => {
  return partners.value.filter((partner) => {
    const countryMatch =
      !filters.value.country || partner.country === filters.value.country;
    const cityMatch =
      !filters.value.city || partner.city === filters.value.city;
    ...
    const partnerTypesMatch =
      !filters.value.partnerTypes.length ||
